public class Beverage {
  ...
  public bool IsEmpty() { return volume == 0; }
...
public class Water : Beverage {
  ...
  public Water(int volume, bool isChilled, string type)
      : base("Water", volume, isChilled) {
    this.waterType = type;
  }

  public Water(int volume, bool isChilled)
      : this(volume, isChilled, "Regular") {}
...
public class Beer : Beverage {
  ...
  public Beer(int volume, bool isChilled, double alcoholicContent)
      : base("Beer", volume, isChilled) {
  ...
  public override string ToString() {
    return base.ToString() +
           $" ({alcoholicContent * 100:0.0}% alcoholic content)";
  }
