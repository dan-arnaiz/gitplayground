...
public class Lion : Pet {
  ...
  public override void MakeNoise() { Console.WriteLine("Roar!"); }
}

public class Dog : Pet {
  private string breed;

  public Dog(string breed) : base("dog", true) { this.breed = breed; }

  public override void MakeNoise() { Console.WriteLine("Arf!"); }
