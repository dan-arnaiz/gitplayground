private async void addNewBarangayButton_Click(object sender, EventArgs e)
{
    ...
    try
    {
        ...
        await db.AddBarangay(pictureBarangayData, BarangayName, barangayAddress, barangayDescription);
    ...
    {
        MessageBox.Show($"Failed to add Barangay. Error: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
}